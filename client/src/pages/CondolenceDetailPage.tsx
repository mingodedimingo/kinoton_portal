      ...
      <div className="container py-6">
        ...
        {isEditing && editForm ? (
          ...
          <>
            ...
            <div className="pb-6" style={{ borderBottom: "1px solid var(--kino-pale)" }}>
              ...
              <div className="flex items-center justify-between mb-3" style={{ borderBottom: "1px solid var(--kino-pale)", paddingBottom: "0.75rem" }}>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="flex items-center gap-1 text-xs" style={{ color: "var(--kino-muted)" }}>
                    <Eye size={11} /> {(item as any).viewCount ?? 0}
                  </span>
                </div>
                {isAdmin && (
              ...
              {item.content ? (
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: injectYoutubeEmbeds(DOMPurify.sanitize(item.content, {
            ...
            {/* ── 댓글 ── */}
            <CommentSection postType="condolence" postId={itemId} />
